...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/11 19:09:51 by awyart            #+#    #+#             */
/*   Updated: 2017/05/19 18:35:04 by awyart           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		conv_u(t_flag *flag, va_list *ap, char content[BUFF_SIZE])
{
	flag->flags['+'] = 0;
	flag->flags[' '] = 0;
	if (flag->flags['l'] == 1)
		...
		ft_itoab_ll((ULL)(unsigned short)va_arg(*ap, unsigned int), 10, AH);
	else if (flag->flags['h'] == 2)
		ft_itoab_ll((ULL)(unsigned char)va_arg(*ap, unsigned int), 10, AH);
